...
namespace NetCoreWebApiRulesEngine.Infrastructure.Shared.Services
{
    public class DatabaseSeeder
    {
        ...
        {
            Departments = GenerateDepartments(seedValue);
            SalaryRanges = GenerateSalaryRanges(seedValue);
        ...
        private static IReadOnlyCollection<SalaryRange> GenerateSalaryRanges(int seedValue)
        {
        ...
        private static IReadOnlyCollection<Department> GenerateDepartments(int seedValue)
        {
