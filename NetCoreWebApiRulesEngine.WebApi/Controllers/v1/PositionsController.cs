...
using NetCoreWebApiRulesEngine.Application.Features.Positions.Commands.DeletePositionById;
using NetCoreWebApiRulesEngine.Application.Features.Positions.Commands.UpdatePosition;
using NetCoreWebApiRulesEngine.Application.Features.Positions.Queries.GetPositionById;
...
namespace NetCoreWebApiRulesEngine.WebApi.Controllers.v1
{
    [ApiVersion("1.0")]
